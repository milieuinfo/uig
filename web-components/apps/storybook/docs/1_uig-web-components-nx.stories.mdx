...
<Meta title="Documentatie/UIG Web Components - Nx" />
...
De __monorepo__ bevat de ontwikkeling die gebeurd door het __UIG-team__ (User Interface Governance Team)
...
De ⚛ <sup>elementen</sup> zijn in de repo te vinden onder __'/libs/elements'__ en worden gepubliceerd onder __@domg-lib/elements__
...
De ⚙ <sup>componenten</sup> zijn in de repo te vinden onder __'/libs/components'__ en worden gepubliceerd onder __@domg-lib/components__
