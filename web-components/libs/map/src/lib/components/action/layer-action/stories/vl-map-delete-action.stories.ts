...
export const deleteActionWithDefaultActive = () => {
    const features = {
        type: 'FeatureCollection',
        features: [
            {
...
deleteActionWithDefaultActive.storyName = 'vl-map-delete-action - with default active';
deleteActionWithDefaultActive.argTypes = {
    active: {
        control: {
            disable: true,
        },
