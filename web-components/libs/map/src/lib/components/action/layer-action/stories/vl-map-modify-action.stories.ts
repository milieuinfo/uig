...
export const modifyActionWithDefaultActive = () => {
    const features = {
        type: 'FeatureCollection',
        features: [
            {
...
modifyActionWithDefaultActive.storyName = 'vl-map-modify-action - with default active';
modifyActionWithDefaultActive.argTypes = {
    active: {
        control: {
            disable: true,
        },
